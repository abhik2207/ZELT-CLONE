...
tl_3.from("#page4>.left-page4>h1, #page4>.left-page4>h4",{
    x:-300,
    opacity:0,
    stagger:0.3,
    scrollTrigger:{
        trigger:"#page4>.left-page4>h1",
        scroller:"#main",
        // markers:true,
        scrub:3,
        start:"top 95%",
...
tl_4.from("#page5>.left-page5>h1, #page5>.left-page5>h4",{
    x:300,
    opacity:0,
    stagger:0.3,
    scrollTrigger:{
        trigger:"#page5>.left-page5>h1",
        scroller:"#main",
        // markers:true,
        scrub:3,
        start:"top 95%",
...
tl_5.from("#page6>.left-page6>h1, #page6>.left-page6>h4",{
    x:-300,
    opacity:0,
    stagger:0.3,
    scrollTrigger:{
        trigger:"#page6>.left-page6>h1",
        scroller:"#main",
        // markers:true,
        scrub:3,
        start:"top 95%",
